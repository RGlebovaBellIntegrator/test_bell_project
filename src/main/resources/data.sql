...
INSERT INTO Users (login, password, firstName, secondName, middleName, position_statement, phone, office_id, doc_code,
...
INSERT INTO Users (firstName, secondName, middleName, position_statement, phone, office_id, doc_code,
                    doc_number, doc_date, countries_code)
            VALUES ('Иван', 'Иванов', 'Иванович', 'Директор', '001', 2, 7,
                    '1234 567890', '2006-01-01', 643);
INSERT INTO Users (login, password, firstName, secondName, position_statement, office_id, doc_code,
                    doc_number, doc_date, countries_code)
            VALUES ('Anna', 'qwerty123', 'Анна', 'Иванова', 'Учительница', 4, 21,
                    '5555 777777', '2014-04-04', 643);
INSERT INTO Users (login, password, firstName, secondName, position_statement, phone, office_id, doc_code,
