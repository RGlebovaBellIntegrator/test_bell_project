...
INSERT INTO Employe (user_id, firstName, secondName, middleName, position_statement, phone, office_id, doc_code,
...
INSERT INTO Employe (user_id, firstName, secondName, position_statement, office_id, doc_code,
                    doc_number, doc_date, countries_code)
            VALUES (3, 'Анна', 'Иванова', 'Учительница', 4, 21,
                    '5555 777777', '2014-04-04', 643);
INSERT INTO Employe (firstName, secondName, position_statement, phone, office_id, doc_code,
